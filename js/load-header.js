                            ...
                            <li>
                                <a href="https://olacheagroup.com/webmail/log-in" class="mobile-nav-link user-login-mobile" target="_blank" rel="noopener noreferrer">
                                    <div class="mobile-user-icon-wrapper">
                                        <img src="/images/user-svgrepo-com.svg" alt="User Login" class="mobile-user-icon">
                                    </div>
                                    Login
                                </a>
                            </li>
                    ...
                    <li class="user-login-container">
                        <a href="https://olacheagroup.com/webmail/log-in" class="user-login-link" target="_blank" rel="noopener noreferrer" aria-label="User Login">
                            <div class="user-icon-wrapper">
                                <img src="/images/user-svgrepo-com.svg" alt="User Login" class="user-icon">
                            </div>
                        </a>
                    </li>
                </ul>
    ...
    if (headerElement) {
        ...
        if (homeLink) {
            homeLink.addEventListener('click', (e) => {
                ...
                if (window.location.pathname.endsWith('/olachea-group/') || window.location.pathname === '/' || window.location.pathname === '/index.html') {
                    e.preventDefault();
                    window.scrollTo({
                        top: 0,
                        behavior: 'smooth'
